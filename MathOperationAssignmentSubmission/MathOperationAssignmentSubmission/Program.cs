...
namespace MathOperationAssignmentSubmission
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int num3 = Convert.ToInt32(numFromUser);
            int num4 = 25;
            int Total1 = num3 + num4;
            Console.WriteLine("The total of your number when Added to 25 is equal to:" + Total);
            Console.ReadLine();
            ...
            float num5 = float.Parse(numFromUser);
            double num6 = 12.5;
            ...
            int num7 = Convert.ToInt32(numFromUser);
            int num8 = 50;
            ...
            int num9 = Convert.ToInt32(numFromUser);
            int num10 = 7;
